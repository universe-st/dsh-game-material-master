...
`;
        ...
        function ConfigSection(props) {
            ...
            }, minimaxCaps.resolutions.map((value) => h("option", { key: value, value }, value)))), h("label", { className: "SPR_field" }, h("span", { className: "SPR_fieldLabel" }, "Base URL（主机根，不含 /v1、/v2、/minimax）"), h("input", {
                className: "SPR_input",
