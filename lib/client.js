...
`;
        ...
        function RigLayoutEditor({ job, selected, onSelect, onCommit, showReference }) {
            ...
            return h("div", null, showReference === true
                ...
                : null, h("div", { className: "SPR_rigCanvasWrap", "data-drag": drag !== null ? "true" : undefined, ref: wrapRef }, h("img", { src: compositeUrl, alt: "composite", onLoad: onImageLoad, draggable: false }), parts.map((part) => {
            ...
            })), h("p", { className: "SPR_hint" }, `画布 ${canvasW}×${canvasH}。点方块选中，拖动即微调位置（松手保存）；也可以在下面对话框里精确调数值。`));
        }
        /**
         * 模块④的主体界面。
         *
