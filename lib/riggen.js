...
import { blitRgba, boxMask, compositeParts, createRgba, detectBackground, groupComponentsByProximity, resizeRgba, segmentWithLabels, sideBySide, solveLayout } from "./rigpose.js";
...
export async function saveLayoutItem(jobId, name, patch) {
    ...
    if (item === undefined)
        throw new Error(`这个部件还没有摆放记录：${name}`);
