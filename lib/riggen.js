...
import { alphaBounds, blitRgba, boxMask, compositeParts, createRgba, detectBackground, groupComponentsByProximity, resizeRgba, rotateRgba, segmentWithLabels, sideBySide, solveLayout } from "./rigpose.js";
...
export async function removeRigPart(jobId, name) {
    ...
    if (node.file !== undefined)
        await rm(rigAssetPath(jobId, node.file), { force: true }).catch(() => undefined);
